...
export const About = () => {
  ...
  const frontendSkills = ["React", "Vue", "Typescript", "TailwindCSS", "Svetle"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              ...
              <li>
                Relevant Coursework: Data Sctructures, Web Development, Cloud Computing...
              </li>
            </ul>
          </div>
          <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="space-y-4 text-gray-300">
              <div>
                ...
                <p>Developed and maintened microservices for cloud-based applications.</p>
              </div>

              <div>
                <h4 className="font-semibold">Inter at DEF Startups (2019)</h4>
